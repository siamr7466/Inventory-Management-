...
export default function StockIn() {
    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            <h1 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: '2rem' }}>Stock In ({user.role === 'admin' ? 'Direct' : 'Request'})</h1>
            ...
            <div className="card">
                <div className="mb-4">
                    ...
                    {!selectedProduct ? (
                        ...
                        <div className="p-4 bg-blue-50 rounded flex justify-between items-center border border-blue-100">
                            <div>
                            ...
                            <button className="text-sm text-blue-600 underline" onClick={() => setSelectedProduct(null)}>Change</button>
                        </div>
                    )}
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-primary w-full" disabled={!selectedProduct}>
                        {user.role === 'admin' ? 'Add Stock' : 'Submit Request'}
                    </button>
                </form>
            </div>
        </div>
